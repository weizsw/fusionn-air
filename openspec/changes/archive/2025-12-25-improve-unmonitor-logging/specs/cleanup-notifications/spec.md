...
The cleanup service SHALL continue showing queued media in the QUEUED section of notifications even after it has been unmonitored, until it is removed.
...
- **AND** it SHALL NOT be returned as "skipped" with reason "not monitored"
...
- **THEN** the notification SHALL show it in QUEUED section with updated countdown
- **AND** it SHALL NOT appear in SKIPPED section
