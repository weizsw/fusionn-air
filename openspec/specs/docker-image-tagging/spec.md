# docker-image-tagging Specification

## Purpose
Defines the Docker image tagging strategy: branch name tags for branch pushes, semver + latest for version tags, published to both GHCR and Docker Hub.
